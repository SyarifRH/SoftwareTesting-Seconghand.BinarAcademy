...
WebUI.setText(findTestObject('Object Repository/Update User/Page_SecondHand/input_No Handphone_userphone_number'), '086493432432')

WebUI.click(findTestObject('Object Repository/Update User/Page_SecondHand/input_No Handphone_userphone_number'))
