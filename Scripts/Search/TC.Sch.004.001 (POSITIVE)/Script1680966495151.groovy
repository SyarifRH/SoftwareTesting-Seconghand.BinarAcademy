...
WebUI.sendKeys(findTestObject('Search/Page_SecondHand/input_Produk Saya_q'), 'IPhone X')

WebUI.sendKeys(findTestObject('Search/Page_SecondHand/input_Produk Saya_q'), Keys.chord(Keys.ENTER))

WebUI.delay(5)

WebUI.verifyElementPresent(findTestObject('Search/Page_SecondHand/h5_Iphone X'), 5)
